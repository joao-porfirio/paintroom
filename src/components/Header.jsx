          ...
          >
            <Fade in={open}>
              <Box sx={style}>
                ...
                >
                  <b>1. </b> Nenhuma parede pode ter menos de 1 metro quadrado
                  nem mais de 50 metros quadrados, mas podem possuir alturas e
                  larguras diferentes;
                </Typography>
                <Typography
                  className="transition-modal-description"
                ...
                >
                  <b>2. </b>O total de área das portas e janelas deve ser no
                  máximo 50% da área de parede;
                </Typography>
                <Typography
                  className="transition-modal-description"
                  sx={{ mt: 1, fontSize: "1.5rem" }}
                >
                  <b>3. </b> A altura de paredes com porta deve ser, no mínimo,
                ...
                <Typography
                  ...
                  sx={{ mt: 2, fontSize: "1.5rem" }}
                >
                  <b>6. </b> Cada litro de tinta é capaz de pintar 5 metros
                  quadrados;
                </Typography>
                <Typography
                  className="transition-modal-description"
                ...
                <Typography
                  ...
                  sx={{ mt: 2, fontSize: "1.5rem" }}
                >
                  <b>Obs: </b> O separador de casas decimais é o ponto (.) Ex:
                  1.98
                </Typography>
              </Box>
            </Fade>
